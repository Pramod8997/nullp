...
> **Current Health:** 433/433 Tests Passing (100%) | Real-World Physical Stress Verified
...
4. **Zero API Hallucinations:** Never invent class names or method signatures. Consult [`claude_context/ARCHITECTURE_AND_APIS.md`](file:///home/pramodsb/Downloads/mjr/claude_context/ARCHITECTURE_AND_APIS.md).
5. **AST Synchronization:** After modifying any code file, execute `graphify update .` (AST-only, zero API cost).
6. **No Regressions:** Verify with `python -m pytest tests/ -q` (baseline is **433 passing tests**).
...
# 2. Run All 433 Regression Tests
python -m pytest tests/ -q

# 3. Run Real-World Physical Stress & HIL Harness
python scripts/real_world_physical_stress.py
python scripts/hil_hardware_test.py

# 4. Run Core 5 Stress & Chaos Suites (209 tests)
...
## 5. Master Documentation Index (`claude_context/`)

* 📄 [`claude_context/INDEX.md`](file:///home/pramodsb/Downloads/mjr/claude_context/INDEX.md) — Master Navigation Index
* 📄 [`claude_context/PROMPT.md`](file:///home/pramodsb/Downloads/mjr/claude_context/PROMPT.md) — Ultra-Dense Master Prompt for Claude Opus 5
* 📄 [`claude_context/PRD.md`](file:///home/pramodsb/Downloads/mjr/claude_context/PRD.md) — Product Requirements Document
* 📄 [`claude_context/TECHNICAL_REVIEW.md`](file:///home/pramodsb/Downloads/mjr/claude_context/TECHNICAL_REVIEW.md) — Technical Review & FreeRTOS Diagrams
* 📄 [`claude_context/ARCHITECTURE_AND_APIS.md`](file:///home/pramodsb/Downloads/mjr/claude_context/ARCHITECTURE_AND_APIS.md) — Complete API Cheatsheet
* 📄 [`claude_context/HARDWARE_DEPLOYMENT_GUIDE.md`](file:///home/pramodsb/Downloads/mjr/claude_context/HARDWARE_DEPLOYMENT_GUIDE.md) — Real-World Hardware Hazards, Schematics & BOM
* 📄 [`claude_context/REAL_WORLD_TESTING_PLAN.md`](file:///home/pramodsb/Downloads/mjr/claude_context/REAL_WORLD_TESTING_PLAN.md) — 8 Physical Bench Tests & Protocols
